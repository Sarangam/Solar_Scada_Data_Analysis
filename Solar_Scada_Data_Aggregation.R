...
p_inverter <- list.files("C:/Users/TOSHIBA/Desktop/rawData",pattern = "-I.*.txt",full.names = TRUE,recursive = TRUE) 

## Load Files of WMS

p_wms <- list.files("C:/Users/TOSHIBA/Desktop/rawData",pattern = "WMS.*.txt",full.names = TRUE,recursive = TRUE) 

p_wms_check <- list.files("C:/Users/TOSHIBA/Desktop/SampleGen1",pattern = "WMS.*.txt",full.names = TRUE,recursive = TRUE) 

## Load files of MFM

p_mfm <- list.files("C:/Users/TOSHIBA/Desktop/rawData",pattern = "MFM.*.txt",full.names = TRUE,recursive = TRUE) 
